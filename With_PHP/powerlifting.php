...
<body>
            ...
            <ul id="navbar">
                ...
                <li> <button>Programs <i class="fa-solid fa-angle-down"></i></button>
                    <div class="dropdown-content">
                        ...
                        <a class="active" href="powerlifting.php">Powerlifting</a>
    ...
    <section id="feature" class="section-p1">
        <div class="fe-box">
            <img src="images/powerlifting/markhenry.jpg">
            <h6>Mark Henry</h6>
        </div>

        <div class="fe-box">
            <img src="images/powerlifting/eddiehall.webp">
            <h6>Eddie Hall</h6>
        </div>

        <div class="fe-box">
            <img src="images/powerlifting/shawstrength.jpg">
            <h6>Shaw Strength</h6>
        </div>

        <div class="fe-box">
            <img src="images/powerlifting/francocolumbo.jpg">
            <h6>Franco Columbo</h6>
        </div>
    </section>
    ...
    <section id="programs" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                ...
                <div class="desc">
                    <button class="normal" id="plT1">Day 1</button>
                    <p id="plP1"></p>
                </div>
            </div>
            ...
            <div class="pro">
                <img src="images/programs/pl.jpg">
                <div class="desc">
                    <button class="normal" id="plT2">Day 2</button>
                    <p id="plP2"></p>
                </div>
            </div>
            ...
            <div class="pro">
                <img src="images/programs/pl.jpg">
                <div class="desc">
                    <button class="normal" id="plT3">Day 3</button>
                    <p id="plP3"></p>
                </div>
            </div>
            ...
            <div class="pro">
                <img src="images/programs/pl.jpg">
                <div class="desc">
                    <button class="normal" id="plT4">Day 4</button>
                    <p id="plP4"></p>
                </div>
            </div>
        </div>
