...
<body>
            ...
            <ul id="navbar">
                ...
                <li> <button>Programs <i class="fa-solid fa-angle-down"></i></button>
                    <div class="dropdown-content">
                        ...
                        <a class="active" href="calisthenics.php">Calisthenics</a>
                    </div>
                </li>
    ...
    <section id="feature" class="section-p1">
        <div class="fe-box">
            <img src="images/calisthenics/thenx.webp">
            <h6>Chris Heria</h6>
        </div>

        <div class="fe-box">
            <img src="images/calisthenics/hannibalforking.jpg">
            <h6>Hannibal For King</h6>
        </div>

        <div class="fe-box">
            <img src="images/calisthenics/isalmbadurgov.jpg">
            <h6>Islam Badurgov</h6>
        </div>

        <div class="fe-box">
            <img src="images/calisthenics/michaelvazquez.webp">
            <h6>Michael Vazquez</h6>
        </div>
    </section>
    ...
    <section id="programs" class="section-p1">
        ...
        <div class="pro-container">
            ...
            <div class="pro">
                ...
                <div class="desc">
                    <button class="normal" id="clT1">Day 1</button>
                    <p id="clP1"></p>
                </div>
            </div>
            ...
            <div class="pro">
                <img src="images/programs/cl.jpeg">
                <div class="desc">
                    <button class="normal" id="clT2">Day 2</button>
                    <p id="clP2"></p>
                </div>
            </div>
            ...
            <div class="pro">
                <img src="images/programs/cl.jpeg">
                <div class="desc">
                    <button class="normal" id="clT3">Day 3</button>
                    <p id="clP3"></p>
                </div>
            </div>
            ...
            <div class="pro">
                <img src="images/programs/cl.jpeg">
                <div class="desc">
                    <button class="normal" id="clT4">Day 4</button>
                    <p id="clP4"></p>
                </div>
            </div>
        </div>
